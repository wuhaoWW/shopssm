...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<!-- 以下方式定时转到其他页面 -->
<!-- 	<meta http-equiv="refresh" content="3;url=/shopssm">  -->
...
<div id="container">
	<!---position area start-->
	<div id="divposition">
		<h2><a href="http://localhost:8082/xindou/default.htm">在线商城-产品论坛-免费购物-宏购网</a> &gt; 会员登录</h2>
	</div>
	<!---position area end-->
	<br>
	<br>
	<div style="border:1px solid #B4C9E0;padding:1px;background-color:#F5FAFE;text-align:center;clear:both;">
		<div class="fgreen" style="margin:0 auto;padding:15px;width:60%;background:url(templates/default//shopssm/resource/frontImage/images/btn-true.gif) no-repeat left center;">

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body> 
		...
		<div id="container">
			<!---position area start-->
			<div id="divposition">
				<h2><a href="http://localhost:8082/xindou/default.htm">在线商城-产品论坛-免费购物-宏购网</a> &gt; 用户注册</h2>
			</div>
			<!---position area end-->
			<!---reg area start--->
			<form id="register_form" name="form"  method="post" action="/shopssm/front/user/register.do">
				...
				<div id="bbs-list-nav">
					...
					<div class="from-nav">
						...
						<div class="Mright">
							...
							<span ><img id="authcodeImg" src="/shopssm/authcode.img" onclick="getAuthcode()" style = "vertical-align: middle"></span>
				...
				填写可选项
						...
						<div id="open">
							<a href="###" onclick="toggle_collapse('regoptions');"><img id="regoptions_img" src="/shopssm/resource/frontImage/images/open_yes.gif" alt="展开">
							</a>
						</div>
					</div>
	...
	<script type="text/javascript" src="/shopssm/resource/js/registerFormCheck.js"></script>
	<script type="text/javascript" src="/shopssm/resource/common/js/util.js"></script>
	<script type="text/javascript" src="/shopssm/resource/common/js/validate.js"></script>
		<script type="text/javascript">
		 		function getAuthcode(){
		 			var authcodeImg = document.getElementById("authcodeImg");
		 			authcodeImg.src = "/shopssm/authcode.img?xx="+Math.random();

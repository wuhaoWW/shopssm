...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<title>会员登录 - 在线商城-产品论坛-免费购物</title>
...
<div id="container">
	...
	<!---position area end-->
<form id="form1" name="form1" method="post" action="/shopssm/front/user/login.action">
<div id="bbs-list-nav">
	<div id="bbs-title">
		<h3>用户登录</h3>
	</div>
	<div class="from-nav">
		...
		<div class="Mright"><input name="username" id="username" size="20" class="colorfocus" onfocus="this.className='colorfocus';" onblur="this.className='colorblue';" type="text">  &nbsp; <a href="http://localhost:8082/shopssm/front/user/toRegister.do" tabindex="-1" accesskey="r" title="立即注册 (ALT + R)">立即注册</a></div>
	</div>
	<div class="from-nav"> 

<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   	 ...
   	 <script type="text/javascript" src = "/shopssm/resource/common/js/cookie.js">
	</script>
 
<div>
	<div id="header">
		<div id="headerlogo">
<!-- 			<h1><a href="http://localhost:8082/xindou/default.htm" title="在线商城-产品论坛-免费购物-新豆网 - " id="logo"><img src="/shopssm/resource/frontImage/images/logo." title="在线商城-产品论坛-免费购物-新豆网 - " border="0"></a></h1> -->
		</div>
		<div id="HeadNavBar">
			<ul id="navlist">
				...
				<c:otherwise>
					<li><a href="/shopssm/front/user/loginOut.action">[退出]&nbsp;</a></li>
						...
						<div id="my_menu" class="downlist" style="display: none;">
							<h4><span class="last"><a href="http://localhost:8082/xindou/user/usercporder.htm">我的订单</a></span></h4>
...
// 							}
				...
				<li class="gwc"><img src="/shopssm/resource/frontImage/images/gwc.gif"><a href="/shopssm/front/shopcart/toPage.do">购物车</a></li>
				<!-- 
					<li><a href="#">在线</a></li> 
				 -->
				 
				<li class="gwc"><a href="#"><b style="color: red">论坛交流区</b></a></li>
				<li class="last"><img src="/shopssm/resource/frontImage/images/help.gif"><a href="#">帮助</a></li>
			</ul>
		</div>
		<div id="HeadNavMenuDiv">			 
			<div id="ServicePhoneDiv"><img src="/shopssm/resource/frontImage/images/servicephone.gif" alt="客服电话:4008206003"></div>			 
			<div>
				<ul id="HeadNavMenu">
					<li class="ActiveMenu" id="rcDefault" onmouseover="ActiveLi(this)" onmouseout="LeaveLi()"><a href="http://localhost:8082/shopssm">首页</a></li>
					
						<li id="rc1" onmouseover="ActiveLi(this)" onmouseout="LeaveLi()"><a href="http://localhost:8082/xindou/rootcategory.htm?id=1">包包</a></li>
					
						<li id="rc2" onmouseover="ActiveLi(this)" onmouseout="LeaveLi()"><a href="http://localhost:8082/xindou/rootcategory.htm?id=2">电脑产品</a></li>
					
						<li id="rc3" onmouseover="ActiveLi(this)" onmouseout="LeaveLi()"><a href="http://localhost:8082/xindou/rootcategory.htm?id=3">数码娱乐</a></li>
					
						<li id="rc4" onmouseover="ActiveLi(this)" onmouseout="LeaveLi()"><a href="http://localhost:8082/xindou/rootcategory.htm?id=4">办公家居</a></li>
					
						<li id="rc5" onmouseover="ActiveLi(this)" onmouseout="LeaveLi()"><a href="http://localhost:8082/xindou/rootcategory.htm?id=5">苹果专区</a></li>
...
<div id="SearchDiv">
	<div id="SearchBar">
		<div id="SearchCenterBar">
			<div id="searchalldiv">
				<a href="http://localhost:8082/xindou/categorylist.htm" target="_blank"><b>[所有分类]</b></a>&nbsp;
				<a href="http://localhost:8082/xindou/brandlist.htm" target="_blank"><b>[所有品牌]</b></a>&nbsp;
			</div>
			<div id="searchdivs">
			...
			<div id="SearchPromotionDiv"><a href="http://localhost:8082/xindou/promotion.htm" target="_blank"> <img src="/shopssm/resource/frontImage/images/xindoutime.gif"></a></div>
		</div>
	</div>
</div>

...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<link rel="stylesheet" href="/shopssm/resource/css/shop.css" type="text/css" media="all"/>
  </head>
...
// 													alert(oldCount+"-----"+count);
													if(oldCount == newCount){
														...
														if(b){ 
															window.location.href="/shopssm/front/shopcart/scUpdate.do?id="+id+"&count="+newCount; 
														}
													}	   
                                    	</script>
                                        </div> 
                                        ...
                                        <div class="ProductTitle">&nbsp;
                                            ...
                                            href="/shopssm/front/shopcart/scDel.do?id=${item.product.id }">删除</a>
                                        </div>
                                        
                                    </div> 
                                    <div class="ProductList-th-l">
                                    <a href="/shopssm/front/product/productDetail.do?id=${item.product.id }" target="_blank">${item.product.name }</a>                                        
                                    </div>
                                </div> 
                           </c:forEach>
                        ...
                        <div id="ProductBottomDiv">
                            <div id="ProductBottom-l">
                                <a href="/shopssm/index.jsp">
                              	  <img src="/shopssm/resource/frontImage/images/continue.gif" border="0">
                                </a> 
                                <a href="/shopssm/front/shopcart/scClear.do">清空购物车</a>
                            </div>
                            ...
                            <div id="ProductBottom-r">
                                <a href="Order_checkout.html"><img src="/shopssm/resource/frontImage/images/checkout.gif"></a> 
                            </div>
                        </div>

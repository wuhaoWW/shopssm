...
<html>
	...
	<head>
		...
		<title>管理员登陆</title>
		<style>
			@import url("/shopssm/resource/css/admin_login.css");
		</style>
	</head>
	<body> 
		<div id = "head"></div>
	  <!--中间-->
				...
				<form action="/shopssm/back/admin/login" method="post">
					<table id = "table">
						...
						<tr> 
							...
							<td> <img src="/shopssm/resource/backImage/images/lock.gif" /> </td>
						</tr>  
						<tr>
							<td>验证码：</td> 
							<td colspan="2">
								<input style="width: 80px" type="text" name="authcode" />
								<span ><img id="authcodeImg" src="/shopssm/authcode.img" 
		...
		<script type="text/javascript">  
		 		function getAuthcode(){
		 			...
		 			authcodeDom.src = "/shopssm/authcode.img?xx="+Math.random();
		 		}
		</script>
</html>
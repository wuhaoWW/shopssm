...
<title>页面跳转</title>
	<style type="text/css">  
 			@import url("/shopssm/resource/404/css/main.css"); 
	</style>
</head>
<body>
<div id="wrapper">
    ...
    <div id="content">
      ...
      <div class="utilities">
          <div class="input-container" style="font: 16px 'TeXGyreScholaRegular', Arial, sans-serif;color: #696969; text-shadow: 0 1px white;text-decoration: none;">
            ...
            <span>如果没有跳转,请 
				<a id="aTag" href="/shopssm${requestScope.nextUrl }">点击这里</a>
			</span>			
          </div>
        <div class="clear"></div>
      </div>
...
<script language="javascript" type="text/javascript">
 ...
 <!--定义js变量及方法-->
	<script language="javascript" type="text/javascript">
			...
			{
				if (second < 0){
					window.location.href = "/shopssm${requestScope.nextUrl }";
				} else{
					if (navigator.appName.indexOf("Explorer") > -1){
						document.getElementById('totalSecond').innerText = second--;
				} else{document.getElementById('totalSecond').textContent = second--; }

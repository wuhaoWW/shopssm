...
<html> 
	<head> 
		...
		<style type="text/css">  
			@import url("/shopssm/resource/easydialog/easydialog.css");
				...
				<table align="center" id="add_table">
					...
					<tr>
						...
						<td> 
							...
							<span>*</span> 
							<div id="number_error">${errors.number}</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td> 
							...
							<span>*</span>
							<div id="remark_error">${errors.remark}</div>
						</td>
					</tr>
					...
					<tr>
						...
						<div id="brandID_error">${errors.brandID}</div>
						</td> 
					</tr>
					...
					<tr>
						...
						<div id="categoryID_error">${errors.categoryID}</div>
						</td>  
					</tr>
					...
					<tr>
						...
						<td> 
							...
							元<span>*</span> 
							<div id="marketPrice_error">${errors.marketPrice}</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td> 
							...
							元<span>*</span> 
							<div id="discountedPrice_error">${errors.discountedPrice}</div>
						</td>
					</tr>
...
<div class="hide_box" id="brand_box">
		...
		<script type="text/javascript" src="/shopssm/resource/ckeditor/ckeditor.js"  >
		</script>  
		<script type="text/javascript" src="/shopssm/resource/easydialog/easydialog.js"  >
		</script>

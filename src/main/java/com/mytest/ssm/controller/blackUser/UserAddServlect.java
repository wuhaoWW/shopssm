...
import com.mytest.ssm.service.impl.UserServiceImpl;
	 ...
	 public class UserAddServlect extends HttpServlet{
		UserServiceImpl userServiceImpl = new UserServiceImpl();
		private final static String toRegister = "/back/user/toAdd.do";
		private final static String index = "/back/user/list.do";

...
public class UserRegisterServlet extends HttpServlet{
	...
	private final static String toRegister = "http://localhost:8082/HgShopSys/front/user/toRegister.do";
	private final static String index = "http://localhost:8082/HgShopSys";
